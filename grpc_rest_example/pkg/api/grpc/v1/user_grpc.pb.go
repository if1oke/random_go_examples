...
const (
	UserService_Get_FullMethodName    = "/v1.UserService/Get"
	UserService_Create_FullMethodName = "/v1.UserService/Create"
)
...
func (c *userServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (UnimplementedUserServiceServer) Create(context.Context, *CreateRequest) (*Empty, error) {
